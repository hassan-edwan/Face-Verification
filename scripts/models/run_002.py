...
Changes: Pair construction updated so same-identity and different-identity
         pairs are sampled with uniform identity weighting, preventing
         prolific identities from dominating the evaluation set.

Outputs:
  outputs/runs/run_002.json
"""
...
# ── CONFIG ───────────────────────────────────────────────────────────────────
PAIRS_CSV = "configs/pairs_v2.csv"
LFW_BASE  = os.path.join(os.getcwd(), "data", "lfw")
OUT_DIR   = "outputs/runs"
RUN_ID    = "run_002_uniform_identity_weighting"
# ─────────────────────────────────────────────────────────────────────────────
...
json_path = os.path.join(OUT_DIR, "run_002.json")
