...
Changes: Pair construction updated to deduplicate canonically so (A,B) and
         (B,A) are not both included, and no exact pair appears twice.

Outputs:
  outputs/runs/run_003.json
"""
...
json_path = os.path.join(OUT_DIR, "run_003.json")
